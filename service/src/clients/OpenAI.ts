...
export const SYSTEM_MESSAGE: SystemMessage = new SystemMessage(`
  You are an assistant whose goal is to help the user to achieve their nutrition goals. Your name is Nourish.
    ...
    this.functions = [
      {
        ...
        description: `Displays a nutritional breakdown for a meal. A breakdown needs to be displayed before we can save the meal. This information should be provided by Nourish and not the user`,
        parameters: {
